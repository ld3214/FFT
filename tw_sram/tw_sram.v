...
//      Test Muxes                  Off
//
//      Creation Date:  Fri Apr 10 10:14:02 2026
//      Version: 	r0p0-00eac0
//
...
`celldefine
`ifdef POWER_PINS
module tw_sram (Q, CLK, CEN, WEN, A, D, EMA, RETN, VSS, VDD);
`else
module tw_sram (Q, CLK, CEN, WEN, A, D, EMA, RETN);
`endif
...
`endif
  ...
  reg NOT_EMA1, NOT_EMA2, NOT_RETN, NOT_WEN;
  reg clk0_int;
  reg CREN_legal;
  initial CREN_legal = 1'b1;
 ...
 wire  CLK_;
  ...
  buf B74(D_[30], D[30]);
  buf B75(D_[31], D[31]);
  buf B76(EMA_[0], EMA[0]);
  buf B77(EMA_[1], EMA[1]);
  buf B78(EMA_[2], EMA[2]);
  buf B79(RETN_, RETN);
