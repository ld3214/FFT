...
//  Stage 1
tw_sram TW1_RE (.CLK(clk), .CEN(1'b0), .WEN(tw_wen), .A(tw1_addr), .D(tw_init_re), .EMA(3'b0), .RETN(1'b1), .Q(s1_tw_re));
tw_sram TW1_IM (.CLK(clk), .CEN(1'b0), .WEN(tw_wen), .A(tw1_addr), .D(tw_init_im), .EMA(3'b0), .RETN(1'b1), .Q(s1_tw_im));

//  Stage 2
tw_sram TW2_RE (.CLK(clk), .CEN(1'b0), .WEN(tw_wen), .A(tw2_addr), .D(tw_init_re), .EMA(3'b0), .RETN(1'b1), .Q(s2_tw_re));
tw_sram TW2_IM (.CLK(clk), .CEN(1'b0), .WEN(tw_wen), .A(tw2_addr), .D(tw_init_im), .EMA(3'b0), .RETN(1'b1), .Q(s2_tw_im));

//  Stage 3
tw_sram TW3_RE (.CLK(clk), .CEN(1'b0), .WEN(tw_wen), .A(tw3_addr), .D(tw_init_re), .EMA(3'b0), .RETN(1'b1), .Q(s3_tw_re));
tw_sram TW3_IM (.CLK(clk), .CEN(1'b0), .WEN(tw_wen), .A(tw3_addr), .D(tw_init_im), .EMA(3'b0), .RETN(1'b1), .Q(s3_tw_im));

//  Stage 4
tw_sram TW4_RE (.CLK(clk), .CEN(1'b0), .WEN(tw_wen), .A(tw4_addr), .D(tw_init_re), .EMA(3'b0), .RETN(1'b1), .Q(s4_tw_re));
tw_sram TW4_IM (.CLK(clk), .CEN(1'b0), .WEN(tw_wen), .A(tw4_addr), .D(tw_init_im), .EMA(3'b0), .RETN(1'b1), .Q(s4_tw_im));

//  Stage 5
tw_sram TW5_RE (.CLK(clk), .CEN(1'b0), .WEN(tw_wen), .A(tw5_addr), .D(tw_init_re), .EMA(3'b0), .RETN(1'b1), .Q(s5_tw_re));
tw_sram TW5_IM (.CLK(clk), .CEN(1'b0), .WEN(tw_wen), .A(tw5_addr), .D(tw_init_im), .EMA(3'b0), .RETN(1'b1), .Q(s5_tw_im));

//  Stage 6
tw_sram TW6_RE (.CLK(clk), .CEN(1'b0), .WEN(tw_wen), .A(tw6_addr), .D(tw_init_re), .EMA(3'b0), .RETN(1'b1), .Q(s6_tw_re));
tw_sram TW6_IM (.CLK(clk), .CEN(1'b0), .WEN(tw_wen), .A(tw6_addr), .D(tw_init_im), .EMA(3'b0), .RETN(1'b1), .Q(s6_tw_im));

//  Stage 7
tw_sram TW7_RE (.CLK(clk), .CEN(1'b0), .WEN(tw_wen), .A(tw7_addr), .D(tw_init_re), .EMA(3'b0), .RETN(1'b1), .Q(s7_tw_re));
tw_sram TW7_IM (.CLK(clk), .CEN(1'b0), .WEN(tw_wen), .A(tw7_addr), .D(tw_init_im), .EMA(3'b0), .RETN(1'b1), .Q(s7_tw_im));

//  Stage 8
tw_sram TW8_RE (.CLK(clk), .CEN(1'b0), .WEN(tw_wen), .A(tw8_addr), .D(tw_init_re), .EMA(3'b0), .RETN(1'b1), .Q(s8_tw_re));
tw_sram TW8_IM (.CLK(clk), .CEN(1'b0), .WEN(tw_wen), .A(tw8_addr), .D(tw_init_im), .EMA(3'b0), .RETN(1'b1), .Q(s8_tw_im));

//  Stage 9
tw_sram TW9_RE (.CLK(clk), .CEN(1'b0), .WEN(tw_wen), .A(tw9_addr), .D(tw_init_re), .EMA(3'b0), .RETN(1'b1), .Q(s9_tw_re));
tw_sram TW9_IM (.CLK(clk), .CEN(1'b0), .WEN(tw_wen), .A(tw9_addr), .D(tw_init_im), .EMA(3'b0), .RETN(1'b1), .Q(s9_tw_im));
